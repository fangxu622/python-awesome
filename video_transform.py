...
parser.add_argument('--video_dir', type=str, default='/data/ActivityNet/videos/v1-3/train_val')
parser.add_argument('--output_dir', type=str, default='/data/ActivityNet/train_val_112')
parser.add_argument('--resolution', type=str, default='224x224')
