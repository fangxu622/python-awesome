...
import pandas as pd
import sys
sys.path.append("/workspace/ActionDetection-AFSD")
...
# with open("/workspace/ActionDetection-AFSD/configs/thumos14_test.yaml", 'r', encoding='utf-8') as f:
#     tmp = f.read()
...
def video2npy(data_path, save_path, sample_fps=10.0, resolution=112,
    ...
    video_infos = []
    for video_name in tqdm( sorted( os.listdir(data_path) ) ):
...
if __name__ == '__main__':
    ...
    #           sample_fps=10.0,
    #           resolution=112)
    data_path = "H:/1-All-Sewer-Data/10-Sewer-T/video"
    save_path ="H:/1-All-Sewer-Data/10-Sewer-T/npy"
    export_video_info_path = "video_info.csv"
    video2npy(data_path,
              save_path,
              export_video_info_path = export_video_info_path,
              sample_fps=8.0,
              resolution=112)
